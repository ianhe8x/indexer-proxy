...
use crate::primitives::cid_deployment;
use crate::rpc::helper::{json, RpcError, RpcHandler, RpcParam};
use crate::server::{Event, GroupType};
...
pub fn init_rpc_handler() -> RpcHandler<State> {
    ...
    rpc_handler.add_method("group-join", |params: Vec<RpcParam>, _state: Arc<State>| async move {
        ...
        let deployment = cid_deployment(gid);
